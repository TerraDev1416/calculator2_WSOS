...
describe("calculator", () => {
  ...
  //Creating a test block for create function
  ...
  //Creating a test block for add function
  it('Addition',async () => {
  ...
  //Creating a test block for multiply function
  ...
  //Creating a test block for divide function
  it('Division',async () => {
